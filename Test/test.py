...
def frames_can(file_name):
    ...
    chdir("D:/Nova pasta/f")
    
    # Executing FramesCan.exe
    framesCAN_dir = main_dir + "\\FramesCAN"
    
    program_dir_path = Path("D:/Nova pasta/f")
    program_path = program_dir_path / "FramesCAN.exe"#[str(program_path)]
...
if __name__ == "__main__":
    item_name = "D:/Nova pasta/f/captura.txt"
